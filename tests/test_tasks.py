...
class TestTask12:
    ...
    def test_bundles_rays(self, rays, bundle_var_name_map):
        ...
        positions = np.array([r.pos if not isinstance(r.pos, MethodType) else r.pos() for r in rb_rays],
                             dtype=np.float64)
        expected_positions = np.array([[-5.000000e+00, 6.123234e-16, 0.],
                                       ...
                                       [-0.5, -0.8660254, 0.],
                                       [-0.5, 0.8660254, 0.],
                                       [-7.34788079e-16, -4.00000000e+00, 0.],
                                       [-3.6739404e-16, -2.0000000e+00, 0.],
                                       [0., 0., 0.],
                                       [1.2246468e-16, 2.0000000e+00, 0.],
                                       [2.4492936e-16, 4.0000000e+00, 0.],
                                       [0.5, -0.8660254, 0.],
                                       [0.5, 0.8660254, 0.],
                                       [0.52094453, -2.95442326, 0.],
                                       [0.52094453, 2.95442326, 0.],
        ...
        sorted_positions = positions[np.lexsort((positions[:, 2], positions[:, 1], positions[:, 0]))]
        sorted_expected_positions = expected_positions[np.lexsort((expected_positions[:, 2],
